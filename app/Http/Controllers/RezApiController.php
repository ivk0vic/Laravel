...
class RezApiController extends Controller
{
    ...
    public function search($datum)
    {
        //vraca sve one rezervacije koje su napravljene za prosledjeni datum u vidu parametra
        //ovo je klasicna pretraga
         return Rezervacija::where('datum','like','%'.$datum.'%')->get();
    }
}
